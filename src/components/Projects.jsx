...
const Projects = () => {
  return (
    <div
      id="projects"
      className="flex flex-col items-center  bg-zinc-850 text-white relative w-full lg:h-[100vh] h-[120vh] m-auto md:pl-20 p-4 pt-10"
    >
      <h1 className="sm:text-5xl text-4xl font-bold text-center py-8">
        Projetos
      </h1>
